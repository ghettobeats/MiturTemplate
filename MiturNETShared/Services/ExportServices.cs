...
public class ExportServices
{
    ...
    public FileStreamResult ToExcel(IQueryable query, string fileName = null)
    {
        ...
        //var pathFileName = $"{exportedFiles}{fileName}";

        //using (var document = SpreadsheetDocument.Create(pathFileName, SpreadsheetDocumentType.Workbook))
    ...
    public async Task<bool> ExportToExcel(IQueryable query, string fileName = null)
    {
        var columns = GetProperties(query.ElementType);
        //var stream = new MemoryStream();
        //
        string exportedFiles = @"file:///C:\SegasaSGOExportedFiles\";
    ...
    public void WriteExcelFile(string outputPath, DataTable table)
    {
